...
class HSU:
    ...
    def plot_eff_map(self, max_speed_pump, max_pressure_discharge, min_speed_pump=1000, min_pressure_discharge=75, pressure_charge=25.0, res=100, show_figure=True, save_figure=False):
        ...
        if self.engine:
            ...
            fig.add_trace(
                go.Scatter(
                    ...
                    (np.pi * speed),
                    name=f"Torque at {self.max_power_input} kW",
